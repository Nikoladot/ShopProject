                        ...
                        <form class="filter-form" method="GET" action="">
                            ...
                            <div class="form-group mb-5">
                                ...
                                <c:forEach var="sticker" items="${stickers}">
	                                ...
	                                <label class="d-flex">
	                                    <input type="checkbox" name="sticker" value="${sticker.id}" <c:if test="${stickersSelected.contains(sticker.id)}" >checked="checked"</c:if> >
	                                    ${sticker.title}
                            ...
                            <div class="form-group mb-5">
                                ...
                                <label class="d-flex">
                                    <input type="radio" name="price" value="1" <c:if test="${priceSelected==1}"> checked="checked" </c:if>  >
                                    &lt; 5000
                                    <!--
                                ...
                                <label class="d-flex">
                                    <input type="radio" name="price" value="2" <c:if test="${priceSelected==2}"> checked="checked" </c:if>>
                                    &lt; 10000
                                    <span class="fake-element"></span>
                                </label>
                                <label class="d-flex">
                                    <input type="radio" name="price" value="3" <c:if test="${priceSelected==3}"> checked="checked" </c:if>>
                                    &lt; 15000
                                    <span class="fake-element"></span>
                                </label>
                            </div>
                          ...
                          <div class="col-xxm-6 col-md-4">
                                <article class="popular-products-item mb-2
                                    ...
                                    <figure class="mb-3 d-flex
                                        ...
                                        align-items-center">
                                        <a href="shop-detail/${product.ceoTitle}/${product.id}" class="d-block"><img src="${product.image}"
                                                alt="" /></a>
